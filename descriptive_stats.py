"""
descriptive_stats.py — Print and save descriptive statistics.
"""
...
def print_clinical_scores(df):
    """Print clinical score summaries."""
    print("\n--- Clinical Scores ---")
...
def print_video_ratings(df):
    """Print valence, arousal, and presence per video."""
...
def print_headtracking_by_video(ht_df):
    """Print headtracking mean speed per video."""
...
def print_headtracking_by_group(merged):
    """Print headtracking mean speed by depression group per video."""
...
def save_descriptive_table(df):
    """Save summary descriptive stats to CSV."""
...
def print_outlier_analysis(df, ht_df):
    """Detect and print outliers using IQR and z-score methods."""
    print("\n--- Outlier Detection ---")
...
def run_descriptive_stats(df, ht_df, merged):
    """Run all descriptive statistics and outlier detection."""
    print("=" * 70)
